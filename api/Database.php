...
//select funkcija
function select ($table="Administrator", $rows = '*', $join_table="kategorije", $join_key1="kategorija_id", $join_key2="id", $where = null, $order = null, $limit=null)
{
...
function update ($table="novosti", $id, $id_value, $keys, $values)
{
$set_query = array();
...
$update = "UPDATE ".$table." SET ". $set_query_string ." WHERE " .$id. " = "  . $id_value;
echo $update;
